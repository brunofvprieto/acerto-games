...
export default function HubGTA6() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4">
      {/* Banner Vice City */}
      <section className="mt-8 overflow-hidden border border-[#C4106B]/50">
        <div
        ...
        >
          ...
          <h1 className="logo-arcade-claro mt-3 text-4xl md:text-6xl">GTA 6</h1>
      ...
      <section className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div key={rotulo} className="border border-edge bg-surface p-4">
            <p className="font-mono text-[10px] uppercase tracking-widest text-[#8E0E4E]">
              {rotulo}
            </p>
      ...
      <section className="py-10">
        <h2 className="mb-4 font-display text-xl uppercase">
          <span className="text-[#C4106B]">▸</span> Cobertura completa
        </h2>
        {materias.length > 0 ? (
