...
function Ticker() {
  ...
  return (
    <div className="bg-arcade text-white overflow-hidden">
      <div className="flex items-stretch">
        <span className="shrink-0 px-3 py-1.5 font-mono text-xs font-bold uppercase tracking-widest bg-shade text-white">
          Últimas
        </span>
    ...
    <header className="sticky top-0 z-50 border-b border-edge bg-ink/90 backdrop-blur">
      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-y-2 px-4 py-3 md:py-4">
        ...
        <nav className="flex items-center gap-5 font-mono text-xs uppercase tracking-widest text-dim max-md:w-full max-md:justify-between max-md:overflow-x-auto max-md:pb-1">
          ...
          <Link href="/gta6" className="whitespace-nowrap text-[#C4106B] hover:text-[#8E0E4E]">GTA 6</Link>
          <Link href="/especial-metal-gear" className="whitespace-nowrap text-[#7A5F0E] hover:text-paper">METAL GEAR</Link>
          <Link href="/artigos" className="whitespace-nowrap text-[#1A5FC8] hover:text-paper">ARTIGOS</Link>
