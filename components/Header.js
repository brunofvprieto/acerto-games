  ...
  return (
    <div className="bg-arcade text-ink overflow-hidden">
      <div className="flex items-stretch">
        <span className="shrink-0 bg-ink px-3 py-1.5 font-mono text-xs font-bold uppercase tracking-widest text-arcade">
          Últimas
        </span>
    ...
    <header className="sticky top-0 z-50 border-b border-edge bg-ink/95 backdrop-blur">
      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-y-2 px-4 py-3 md:py-4">
        <div className="flex items-center gap-3">
          <Link href="/" className="logo-arcade text-xl" aria-label="Acerto Games — início">
        ...
        <div className="flex items-center gap-5 max-md:w-full max-md:order-last">
          <HeaderSearch />
          <nav aria-label="Navegação principal" className="flex items-center gap-5 font-mono text-xs uppercase tracking-widest text-dim max-md:w-full max-md:justify-between max-md:overflow-x-auto max-md:pb-1">
            ...
            <Link href="/opinioes" className="whitespace-nowrap text-[#FF9A6B] hover:text-paper">OPINIÃO</Link>
