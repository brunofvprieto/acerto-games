      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-y-2 px-4 py-3 md:py-4">
        ...
        <div className="flex items-center gap-3 max-md:w-full max-md:order-last">
          ...
          <nav className="flex items-center gap-4 font-mono text-xs uppercase tracking-widest text-dim max-md:w-full max-md:overflow-x-auto max-md:pb-1">
            ...
            <Link href="/gta6" className="whitespace-nowrap shrink-0 text-[#FF2E97] hover:text-[#FF9AD1]">
              GTA 6
            </Link>
            ...
            <Link href="/#noticias" className="whitespace-nowrap shrink-0 hover:text-paper">
              Notícias
            </Link>
            <Link href="/#reviews" className="whitespace-nowrap shrink-0 hover:text-paper">
              Reviews
            </Link>
            <Link href="/#retro" className="whitespace-nowrap shrink-0 hover:text-retro">
              Retrô
            </Link>
          </nav>
        </div>
